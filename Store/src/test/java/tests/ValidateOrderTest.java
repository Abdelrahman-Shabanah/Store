...
public class ValidateOrderTest extends TestBase{
	...
	BankWirePage BankWireObject;
	OrdersPage OrdersObject;
	
	@Test(dataProvider = "LoginData")
	public void ConfirmPayment(String Email, String Password) throws InterruptedException {
		...
		BankWireObject = new BankWirePage(driver);
		BankWireObject.ConfirmWithBankWire();
		BankWireObject.BackToOrder();
		
		OrdersObject = new OrdersPage(driver);
		OrdersObject.ValidateBankWire();
